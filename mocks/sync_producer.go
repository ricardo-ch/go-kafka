...
// AbortTxn provides a mock function with no fields
func (_m *SyncProducer) AbortTxn() error {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for AbortTxn")
	}
...
func (_m *SyncProducer) AddMessageToTxn(msg *sarama.ConsumerMessage, groupId string, metadata *string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for AddMessageToTxn")
	}
...
// AddMessageToTxnWithGroupMetadata provides a mock function with given fields: msg, groupMetadata, metadata
func (_m *SyncProducer) AddMessageToTxnWithGroupMetadata(msg *sarama.ConsumerMessage, groupMetadata *sarama.ConsumerGroupMetadata, metadata *string) error {
	ret := _m.Called(msg, groupMetadata, metadata)

	if len(ret) == 0 {
		panic("no return value specified for AddMessageToTxnWithGroupMetadata")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(*sarama.ConsumerMessage, *sarama.ConsumerGroupMetadata, *string) error); ok {
		r0 = rf(msg, groupMetadata, metadata)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *SyncProducer) AddOffsetsToTxn(offsets map[string][]*sarama.PartitionOffsetMetadata, groupId string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for AddOffsetsToTxn")
	}
...
// AddOffsetsToTxnWithGroupMetadata provides a mock function with given fields: offsets, groupMetadata
func (_m *SyncProducer) AddOffsetsToTxnWithGroupMetadata(offsets map[string][]*sarama.PartitionOffsetMetadata, groupMetadata *sarama.ConsumerGroupMetadata) error {
	ret := _m.Called(offsets, groupMetadata)

	if len(ret) == 0 {
		panic("no return value specified for AddOffsetsToTxnWithGroupMetadata")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(map[string][]*sarama.PartitionOffsetMetadata, *sarama.ConsumerGroupMetadata) error); ok {
		r0 = rf(offsets, groupMetadata)
	} else {
		r0 = ret.Error(0)
	}
...
// BeginTxn provides a mock function with no fields
func (_m *SyncProducer) BeginTxn() error {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for BeginTxn")
	}
...
// CommitTxn provides a mock function with no fields
func (_m *SyncProducer) CommitTxn() error {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for CommitTxn")
	}
...
// IsTransactional provides a mock function with no fields
func (_m *SyncProducer) IsTransactional() bool {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for IsTransactional")
	}
...
// TxnStatus provides a mock function with no fields
func (_m *SyncProducer) TxnStatus() sarama.ProducerTxnStatusFlag {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for TxnStatus")
	}
...
func NewSyncProducer(t interface {
	mock.TestingT
	Cleanup(func())
}) *SyncProducer {
	mock := &SyncProducer{}
